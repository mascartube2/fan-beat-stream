...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Pulse — Music & Community" },
      { property: "og:description", content: "Stream music. Follow artists. Join lives. Chat directly." },
